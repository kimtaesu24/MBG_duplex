...
def parse_args():
    ...
    p.add_argument("--output-dir", default="/home6/duplex/personaplex/moshi/moshi/ARTalk/train_code/outputs/SoftVQContinuousOnline_v2_mimi_mtp")
    ...
    p.add_argument("--wandb-run-name", default="softvq_v2_mimi_mtp")
    args = p.parse_args()
