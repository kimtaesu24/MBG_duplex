...
from finetune.eval2 import evaluate
...
from finetune.wrapped_model2 import get_fsdp_model
    ...
    while state.step < args.max_steps:
        ...
        for i in range(args.num_microbatches):
            ...
            with sync_ctx:
                ...
                # ([...,0]=user, [...,1]=agent); targets are per-frame energy VAD
                # extracted from the stereo waveform in the interleaver (row0=user, row1=agent).
                if (args.backchannel.enable
